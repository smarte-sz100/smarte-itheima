...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "kUOibEpOmis1y0UWN0mNOITuW4ywmFijaIogtpS8";
    private static final String SECRETKEY = "bYYVc3tNO5ksGp2Q7qmndMUUEKoQbP2K7adNKB2v";
    private static final String BUCKET = "smarte100";
    public static final String DOMAIN= "http://qgzwplbwf.hn-bkt.clouddn.com/";
